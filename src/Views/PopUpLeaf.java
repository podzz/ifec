 ...
 * @author Flash
 */
public class PopUpLeaf extends javax.swing.JPanel {
     ...
     */
    public PopUpLeaf(JXTree t, Object[] path) {
        initComponents();
        t_ = t;
        path_ = path;
    ...
    private void initComponents() {
        ...
        jXButton1.setText("Supprimer le compte");
    ...
    private void jXButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jXButton1ActionPerformed
        ...
        if (!tools.check_calc_for_delete_node(path_)) {
